...
(function($) {
	...
	var FractionSlider = function(element, options){
		...
		function init(){
			...
			// controls
			if(options['controls']){
				slider.parent().parent().append('<a href="#" class="prev"><i class="icon-angle-left icon-2x"></i></a><a href="#" class="next"><i class="icon-angle-right icon-2x"></i></a>');
				
				slider.parent().parent().find('.next').bind('click', function(){
					return nextBtnPressed();
				});
				slider.parent().parent().find('.prev').bind('click', function(){
